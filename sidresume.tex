...
\address{ss2620@ic.ac.uk \\ \href{https://siddharthsrivastava.co.uk}{siddharthsrivastava.co.uk}} 
...
\begin{document}
    ...
    % \begin{rSection}{Other Details}
    %     \begin{itemize}
    %         \item Mr Siddharth Srivastava, Indian.
    %         \item Resident of the UK since September 2020. Resident of Singapore from March 2010 till August 2020.
    %         \item Address: Flat 7 Beatrice Court, 15 Queens Road, London NW42TL.
    %         \item Contact: \verb|ss2620@ic.ac.uk|, +44 (0) 7873444886
    %         \item English: Native; Hindi: Fluent; Marathi: Fluent.
    %     \end{itemize}
